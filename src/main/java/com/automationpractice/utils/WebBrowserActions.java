...
public class WebBrowserActions {
	...
	static Logger log = LogManager.getLogger(WebBrowserActions.class);
	...
	public static void initializeCommonProperties() {
		...
		try {
			...
			Browser = PropUtils.fetchProperty("Web.Browser", configFolderPath + "common.properties");
			Environment = PropUtils.fetchProperty("Web.Environment", configFolderPath + "common.properties");
		} catch (Exception e) {
