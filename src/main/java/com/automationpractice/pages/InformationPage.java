...
public class InformationPage extends WebPageActions {
	
	Logger log = LogManager.getLogger(InformationPage.class.getSimpleName());
	
	public InformationPage() {
		super(InformationPage.class.getSimpleName());
	}
