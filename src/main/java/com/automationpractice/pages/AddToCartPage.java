...
public class AddToCartPage extends WebPageActions {
	
	Logger log = LogManager.getLogger(AddToCartPage.class.getSimpleName());
	
	public AddToCartPage() {
		super(AddToCartPage.class.getSimpleName());
	}
